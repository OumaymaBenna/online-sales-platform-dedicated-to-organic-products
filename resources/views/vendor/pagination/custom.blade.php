@if ($paginator->hasPages())
    <nav>
        <ul class="pagination" style="justify-content:center;align-items:center;">
            ...
            @else
                <li class="page-item">
                    <a class="page-link" href="{{ $paginator->previousPageUrl() }}" rel="prev" aria-label="Précédent"><i class="fas fa-chevron-left"></i></a>
                </li>
            @endif
            ...
            @if ($paginator->hasMorePages())
                <li class="page-item">
                    <a class="page-link" href="{{ $paginator->nextPageUrl() }}" rel="next" aria-label="Suivant"><i class="fas fa-chevron-right"></i></a>
                </li>
            @else
